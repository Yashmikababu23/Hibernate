...
public class PayrollController {
	...
	/*@GetMapping("/payroll/download")
	public ResponseEntity<Resource> downloadEmployee(HttpServletRequest request) {
		logger.info("inside the download method");
		List<Employee> employees = payrollService.getEmployee();
		Resource resource = ExcelUtils.writeExcel(employees);
