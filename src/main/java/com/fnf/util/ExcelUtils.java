...
public class ExcelUtils {
	...
	private static final String[] columns = new String[] { "EmployeeId", "EmployeeName", "Department", "DOJ","CTC","Type","Installments","Variable","Bonus"};
/*
	public static Resource writeExcel(List<Employee> employees) {
		...
		try {
			fileOut = new FileOutputStream("D:\\poi-generated-file.xlsx");
		...
		URL url = null;
		try {
			url = new URL("file:D:/poi-generated-file.xlsx");
	...
	public static List<Employee> readEmployeeSheetExcel(MultipartFile file) throws Exception {
		...
		for (int i = 1; i < worksheet.getPhysicalNumberOfRows(); i++) {
			...
			employee.setDateOfJoining(new SimpleDateFormat("dd/MM/yyyy").parse(dateofJoining));
			employee.setPaymentCycle(new SimpleDateFormat("dd/MM/yyyy").parse(paymentCycle));
